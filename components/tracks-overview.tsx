...
export function TracksOverview({ tracks }: TracksOverviewProps) {
        ...
        >
          {tracks.map((track, index) => (
            <motion.div
              ...
              className="h-full"
            >
              <Card className="h-full hover:shadow-2xl transition-all duration-500 border-0 bg-gradient-to-br from-card to-card/50 backdrop-blur-sm relative overflow-hidden group">
